...
public class UIParticleSystem : MonoBehaviour {
    ...
    /// </summary>
    public float EmissionAngle = 145f;
    ...
    void Update ()
    {
        EmissionAngle = Random.RandomRange(0, 90);
        EmissionsPerSecond = Random.RandomRange(2, 5);
	}
    ...
    //Deactivate all the particles when we disable the system
